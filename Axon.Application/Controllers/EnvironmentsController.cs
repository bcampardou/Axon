...
namespace Axon.Application.Controllers
{
    ...
    public class EnvironmentsController : ControllerBase
    {
        ...
        [Route("{id}")]
        [HttpGet]
        public async Task<ProjectEnvironmentDTO> Get(Guid id, [FromServices]IProjectEnvironmentsService service)
        {
        ...
        [Route("{id}")]
        [HttpDelete]
        public async Task<object> Delete(Guid id, [FromServices]IProjectEnvironmentsService service)
        {
