...
namespace Axon.Application.Controllers
{
    ...
    public class TechnologiesController : ControllerBase
    {
        ...
        [Route("{id}")]
        [HttpGet]
        public async Task<TechnologyDTO> Get(Guid id, [FromServices]ITechnologiesService service)
        {
        ...
        [Route("{id}")]
        [HttpDelete]
        public async Task<object> Delete(Guid id, [FromServices]ITechnologiesService service)
        {
